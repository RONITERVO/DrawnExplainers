 ...
 */
export function travel(draw, p, { from = 660, to = 1320, y = 560, alone = W / 2, ghost = 0.34, inset = 250 } = {}) {
  const e = easeInOut(clamp01(p));
  const held = draw(0, lerp(alone, from, e), lerp(1, ghost, e));
  ...
  return held + tie + draw(e, lerp(lerp(alone, from, e), to, e), 1);
}
